...
Implementation commit `8e55c6afae20ca64b9ea9bba5861bc85d8017c62` was pushed to `origin/v0.3.0`. GitHub Actions run `31635798035` succeeded on that exact clean commit: configured tests/lint/assemble, embedded provenance and fixed-certificate v2 signature checks all passed. The uploaded V0.3.2/v24 APK is 2,554,982 bytes with SHA-256 `841b1a4adb9f9e4a1834d2830dd6e94754a54cbcc3b2b3209023061da1969e9b`. Exact-commit CI is therefore complete; API 27, paired-OBD save/recovery smoke and the same-period E1 remain pending, so this is still not a promoted baseline.
